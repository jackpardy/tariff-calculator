...
var CommonSkills = map[string]TrampolineSkill{
	...
	"baraniBallOut":   {Name: "Barani Ball-Out", Rotation: 5, TwistDistribution: []int{1, 0}, TakeoffPosition: Back, Backward: false, Shape: Tuck, SeatLanding: false},
	"rudiBallOut":     {Name: "Rudi Ball-Out", Rotation: 5, TwistDistribution: []int{3, 0}, TakeoffPosition: Back, Backward: false, Shape: Straight, SeatLanding: false},
